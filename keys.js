...
|i_CTRL-X_s|		CTRL-X s	spelling suggestions
  ...
  videos: {
    ...
    'numbering_lists': { name: 'Numbering Lists', description: 'Numbering lists with `^a`.', keys: ['^a'], link: 'https://youtube.com/shorts/hWO3zoRAbaE' },
    'useless_underscore': { name: 'Useless Underscore', description: 'The underscore key is useless, remap it!', keys: ['_'], link: 'https://youtube.com/shorts/_qhSi-5sNaA' },
    'basic_motions_1': { name: 'Basic Motions 1', description: 'Moving around with `h` `j` `k` `l`.', keys: ['h','j','k','l','<Left>','<Right>','<Up>','<Down>','<Space>','<BS>'], link: 'https://youtube.com/shorts/hYRueT4IC8U' },
    'basic_motions_2': { name: 'Basic Motions 2', description: 'Moving by words with `w` `b` `e` `ge`.', keys: ['w','b','e','ge'], link: 'https://youtube.com/shorts/Y2Ck7hcMGnE' },
    'basic_motions_3': { name: 'Basic Motions 3', description: 'Moving by big WORDS with `W` `B` `E` `gE`.', keys: ['W','B','E','gE'], link: 'https://youtube.com/shorts/eDJ6GAEUNuA' },
    'basic_motions_4': { name: 'Basic Motions 4', description: 'Moving horizontally with `$` `^` `0`.', keys: ['$','^','0'], link: 'https://youtube.com/shorts/wvCf6A7E4SE' },
    'basic_motions_5': { name: 'Basic Motions 5', description: 'Moving vertically with `L` `H` `M` `gg` `G`.', keys: ['L','H','M','gg','G'], link: 'https://youtube.com/shorts/HkQo2D18hvw' },
    'basic_motions_6': { name: 'Basic Motions 6', description: 'Moving by sentences and paragraphs with `(` `)` `{` `}`.', keys: ['(',')','{','}'], link: 'https://youtube.com/shorts/JrotwsWAPbA' },
    'basic_motions_7': { name: 'Basic Motions 7', description: 'Moving by sections with `]]` `[[` `][` `[]`.', keys: [']]','[[','][','[]'], link: 'https://youtube.com/shorts/TNZqwtivh9o' },
    ...
    'visual_modes': { name: 'Visual Modes', description: 'Visual mode with `v`, visual line mode with `V`, and visual block mode with `^v` or `^q`.', keys: ['v','V','^v','^q'], link: 'https://youtube.com/shorts/eQhXOJRPk38' },
    'undo': { name: 'Undo', description: 'Undoing changes with `u` and `U`. Redoing them with `^r`.', keys: ['u','U','^r'], link: 'https://youtube.com/shorts/H-lUXQNtfSg' },
    'delete_char': { name: 'Delete Character', description: 'Deleting characters with `x` and `X`.', keys: ['x','X'], link: 'https://youtube.com/shorts/d6VHSZwza8Y' },
    'jumps': { name: 'Jumps', description: "Navigating jumps with `''` ```` `^o` `^i`.", keys: ["''",'``','^o','^i'], link: 'https://youtube.com/shorts/AckbVYtWf3A' },
    'indenting': { name: 'Indenting', description: 'Indenting, unindenting and autoindenting with `<{motion}` `<<` `>{motion}` `>>` `={motion}` `==`.', keys: ['<<','<','>>','>','==','=','v_=','v_<','v_>'], link: 'https://youtube.com/shorts/_OLiloA13Yg' },
    'replace': { name: 'Replace', description: "Replacing characters with `r` and `R`.", keys: ['r','R'], link: 'https://youtube.com/shorts/UlT4fdNVB9k' },
    'delete': { name: 'Delete', description: "Deleting with `d{motion}`, `dd`, `D` and `d` in Visual mode.", keys: ['dd','d','D','vd'], link: 'https://youtube.com/shorts/2LpYVftxgYE' },
    'put': { name: 'Put', description: "Put with `p` and `P` and about line behavior.", keys: ['p','P'], link: 'https://youtube.com/shorts/qKXcZVSRauo' },
    'yank': { name: 'Yank', description: "Yank with `y{motion}` `yy` `Y` and in `y` in Visual mode. Also `:map Y y `yy` `Y` and in `y` in Visual mode. Also `:map Y y$`.", keys: ['y','yy','Y','v_y'], commands: [`:map Y y$`], link: 'https://youtube.com/shorts/y-6pfn8f7ts' },
    'patterns': { name: 'Patterns', description: "Common patterns of usage: `xp` `deep` `ddp` `ddP` `yyp`.", link: 'https://youtube.com/shorts/Oe7WDNjlLeI' },
    'text_obj_1': { name: 'Text Objects 1', description: "Specifying inner/around quotes, single-quotes and back ticks.", textobj: ['i"','a"',"i'","a'",'i`','a`'], link: 'https://youtube.com/shorts/OmQ0yii-ps8' },
    'text_obj_2': { name: 'Text Objects 2', description: "Specifying inner/around square brackets, parenthesis, curly braces and angle brackets.", textobj: ['i[','i]','a[','a]','i(','i)','ib','a(','a)','ab','i{','i}','iB','a{','a}','aB','i<','i>','a<','a>'], link: 'https://youtube.com/shorts/Oe7TyN3c58U' },
    'text_obj_3': { name: 'Text Objects 3', description: "Specifying inner/around words, WORDS, sentences and paragraphs.", textobj: ['iw','aw','iW','aW','ip','ap','is','as'], link: 'https://youtube.com/shorts/i1x06goMVck' },
    'text_obj_4': { name: 'Text Objects 4', description: "Specifying inner/around HTML and XML tags..", textobj: ['it','at'], link: 'https://youtube.com/shorts/HcnL02LqzZ8' },
    'insert': { name: 'Insert', description: "Insert mode with `i`, `a`, `I`, and `A`.", keys: ['i','I','a','A'], link: 'https://youtube.com/shorts/5KsCYFnh0k8' },
    'insert_adv': { name: 'Advanced Insert', description: "Advanced insert mode with `gi` and `gI`.", keys: ['gi','gI'], link: 'https://youtube.com/shorts/qWVlE0IWaug' },
