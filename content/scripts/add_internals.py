...
CALLOUTS = [
    ...
    ("parts/05-counts-visual/01-counts.json",
    ...
    ("parts/05-counts-visual/03-char-visual.json",
    ...
    ("parts/05-counts-visual/04-line-block.json",
    ...
    ("parts/05-counts-visual/05-tricks.json",
