...
\begin{tikzpicture}[x=\dimexpr 0.22cm, y=\dimexpr 0.36cm]
  ...
  \node[anchor=base west, inner sep=0pt, font=\ttfamily\small] at (0.05, -1) {range 5};
  \node[anchor=base west, inner sep=0pt, font=\ttfamily\small] at (0.05, -2) {armor 5};
  ...
  \draw[black, very thick] (0, 0.25) rectangle (1, -0.75);
